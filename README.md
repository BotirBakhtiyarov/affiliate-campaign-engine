...
- **Meta Ads publisher** — publish campaign, ad set, and ad directly to Meta (demo mode without credentials).
...
- Full Meta Marketing API publishing with OAuth and business-account support.
